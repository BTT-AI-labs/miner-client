...
def test_settings_prefers_explicit_miner_urls(monkeypatch) -> None:
    ...
    monkeypatch.setenv("MODELDOCK_INFERENCE_API_KEY", "modeldock-key")
    ...
    monkeypatch.setenv("MINER_VLLM_API_KEY", "vllm-key")
